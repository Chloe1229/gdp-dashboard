if "s2_4" in step6_targets:
    if (
        ...
        step6_selections.get("s2_4_req_2") == "충족" and
        step6_selections.get("s2_4_req_3") == "충족" and
        step6_selections.get("s2_4_req_4") == "충족" and
        step6_selections.get("s2_4_req_5") == "충족" and
        step6_selections.get("s2_4_req_6") == "충족" and
        step6_selections.get("s2_4_req_7") == "충족" and
        step6_selections.get("s2_4_req_8") == "충족" and
        step6_selections.get("s2_4_req_9") == "충족" and
        step6_selections.get("s2_4_req_10") == "충족"
    ):
